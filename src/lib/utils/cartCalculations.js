...
export const calculateTotalQuantity = (cartItems) =>
  ...
  export const calculateDiscountAmount = (totalCost, couponState) => {
    ...
    return discountType === 'percentage'
      ? (totalCost * couponDiscount) / 100
      : couponDiscount;
  };
  
  export const calculateFinalDiscount = (discountAmount, totalCost) =>
    Math.min(discountAmount, totalCost);
  
  export const calculateTotalCostAfterDiscount = (totalCost, finalDiscount) =>
